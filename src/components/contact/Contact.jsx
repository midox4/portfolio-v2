...
import anim from "../../assets/anim4.json";
import sendmail from "../../assets/anim6.json";
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">hafsi.ahmed@hotmail.fr</span>

              <a
                href="mailto:hafsi.ahmed@hotmail.fr"
